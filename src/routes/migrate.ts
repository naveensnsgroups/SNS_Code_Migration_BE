...
// HITL graph-review checkpoint — the per-graph result the user reviews after
// graph-resolution. Returned separately so the review UI can fetch it directly.
...
// HITL — Continue: resume Stage 1 into section-writing from the checkpoint.
...
// HITL — Skip: forfeit the analysis report and mark Stage 1 complete so Stage 2
